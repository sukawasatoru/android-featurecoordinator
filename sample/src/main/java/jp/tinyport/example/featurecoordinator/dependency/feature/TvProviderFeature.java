...
import jp.tinyport.example.featurecoordinator.dependency.dependency.PackageNameDependency;
...
public class TvProviderFeature implements Feature {
    @Override
    ...
    public List<Dependency> getDependencyList() {
        return Collections.singletonList(new PackageNameDependency("com.android.providers.tv"));
    }
