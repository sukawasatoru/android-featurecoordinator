...
import jp.tinyport.example.featurecoordinator.dependency.dependency.SdkVersionDependency;
...
public class Java8Feature implements Feature {
    @Override
    ...
    public List<Dependency> getDependencyList() {
        return Collections.singletonList(new SdkVersionDependency(Build.VERSION_CODES.N));
    }
